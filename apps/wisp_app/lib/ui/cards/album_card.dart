...
/// A [GenericCard] for a [GenericAlbum].
///
/// Takes the full [GenericAlbum] rather than [GenericSimpleAlbum] since
/// that's what's already on hand at every current call site; if you're
/// holding a [GenericSimpleAlbum] instead, convert it first with its
/// existing `.toAlbum()`.
class AlbumCard extends StatelessWidget {
  ...
  Future<void> _toggleAlbumPlayback(BuildContext context) async {
    ...
    if (audioHandler != null) {
      ...
      } else { // Album is not active, so play it.
