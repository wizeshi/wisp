...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) wisp_audio_output_info_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "WispAudioOutputInfoPlugin");
  wisp_audio_output_info_plugin_register_with_registrar(wisp_audio_output_info_registrar);
}
